...
/******* basic operations for adding users, roles, groups *******/
exports.addUser = function ( name ) {
  exports._data.users.push( name );
  //sys.puts(JSON.stringify(exports._data.users));
};
...
exports.addUserToGroup = function ( user, group ) {
  exports._data.groups[group].users.push( user );
  //sys.puts(JSON.stringify(exports._data.groups[group].users));
};
...
String.prototype.can = function ( role ) {
  ...
  for(var g in groups){
    sys.puts(groups[g].roles[role] + this);
  }
